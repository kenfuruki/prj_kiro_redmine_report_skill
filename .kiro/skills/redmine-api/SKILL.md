...
**上限: 最大5件まで。** CSVの記載順で先頭5件を対象とし、6件目以降はプレースホルダーのまま残す。
...
6件以上のAIフラグがある場合は「AI考察は上限5件のため、残りN件はプレースホルダーのままです。」と追記する。
...
- AI考察（AIフラグ付きのみ）
- 課題・Q/A・サポートの折れ線グラフ（合計数 vs 解決・終了数）
- トラッカー別ステータス推移テーブル（4定点）
- 成果物の予実管理テーブル
